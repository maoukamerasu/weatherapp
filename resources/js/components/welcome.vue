<template>
    <div>
        <table border="0" bgcolor="#008080">
            <tr bgcolor="#808000"><th colspan="2">福岡市<br>{{weather.today}}({{weather.week}})</th></tr>
            ...
            <tr bgcolor="#cccccc"><th>最低気温</th><th>{{weather.min}}℃</th></tr>
            <tr bgcolor="#cccccc"><th>最高気温</th><th>{{weather.max}}℃</th></tr>
